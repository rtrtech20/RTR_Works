...
(function () {
  ...
  function t(n, o) {
    for (var r in o)
      "Object" === e(o[r])
        ? ("object" !== _typeof(n[r]) && (n[r] = {}), (n[r] = t(n[r], o[r])))
        : (n[r] = o[r]);
    return n;
  }
  function n() {
  ...
  function o(e) {
    if (
      ...
      t.setAttribute("id", "global-error"),
        t.setAttribute(
          "style",
  ...
  function r(e) {
    ...
    if (o !== !1 && 12 > o) {
      ...
      (i.src = "./components/base/support.js"),
  ...
  (r.defaults = {
    ...
    debug: !1,
    IEPolyfill:
      "https://polyfill.io/v3/polyfill.min.js?features=Array.from%2CCustomEvent%2CNodeList.prototype.forEach%2CObject.assign%2CIntersectionObserver%2CPromise",
    IEHandler: null,
    onScriptsReady: null,
    onStylesReady: null,
    onError: o,
    ...
    (r.prototype.checkComponent = function (e) {
      ...
      return new Promise(function (n) {
        ...
        o && "absent" !== o.state
          ? "ready" === o.state
            ? n()
            : window.addEventListener("".concat(e, ":readyScripts"), n)
          : n();
      });
    }),
    ...
    (r.prototype.includeScript = function (e) {
      return new Promise(function (t, n) {
        ...
        if (o)
          "true" === o.getAttribute("data-loaded")
            ? t()
            : (o.addEventListener("load", t), o.addEventListener("error", n));
        else {
    ...
    (r.prototype.initComponent = function (e) {
      ...
      return (
        ...
        e.styles &&
          (t = t
            .then(this.makeAsync.bind(this, e.styles, this.includeStyles))
            ["catch"](this.onError)),
        e.script &&
          (n = n
            .then(this.makeSync.bind(this, e.script, this.includeScript))
            ["catch"](this.onError)),
        e.dependencies &&
          (n = n
            .then(
            ...
            ["catch"](this.onError)),
        e.init &&
          (n = n.then(e.init.bind(this, e.nodes))["catch"](this.onError)),
        t.then(function () {
          window.dispatchEvent(
            new CustomEvent("".concat(e.name, ":readyStyles"))
          );
        }),
        n.then(function () {
          window.dispatchEvent(
            new CustomEvent("".concat(e.name, ":readyScripts"))
          ),
            (e.state = "ready");
        }),
        { scriptsState: n, stylesState: t }
      );
    }),
    (r.prototype.initComponents = function (e, t) {
      ...
      for (var s in i) {
        var c = i[s];
        (c.name = s),
          (c.nodes = Array.from(e.querySelectorAll(c.selector))),
          "HTMLElement" === e.constructor.name &&
            e.matches(c.selector) &&
            c.nodes.unshift(e),
          !c.styles || c.styles instanceof Array || (c.styles = [c.styles]),
          !c.script || c.script instanceof Array || (c.script = [c.script]),
          !c.dependencies ||
            c.dependencies instanceof Array ||
            (c.dependencies = [c.dependencies]),
          c.nodes.length ? (c.state = "pending") : (c.state = "absent");
      }
      for (var a in i) {
        var d = i[a];
        if ("pending" === d.state) {
      ...
      Promise.all([
        Promise.all(r).then(function () {
          n.debug &&
            ...
            n.onScriptsReady instanceof Function && n.onScriptsReady.call(n),
        ...
        Promise.all(o).then(function () {
          n.debug &&
            ...
            n.onStylesReady instanceof Function && n.onStylesReady.call(n),
        ...
        n.debug &&
          ...
          t instanceof Function && t.call(n),
          n.onReady instanceof Function && n.onReady.call(n),
