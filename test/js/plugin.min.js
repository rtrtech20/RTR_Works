...
!(function (e, t) {
        ...
        "string" == typeof e &&
          (e =
            "#" === e.charAt(0) && -1 === e.indexOf(" ")
              ? ae.querySelector(e)
              : ae.querySelectorAll(e)),
        !e)
      )
        return !1;
      var R = i.Helpers;
      void 0 !== t.maxWidth &&
        (R.deprecated("maxWidth", "disableAt", "option"),
        ...
        n = function (e) {
          if (e.querySelector("ul") || "UL" === e.tagName) {
            var E = "hc-nav-" + ++ie,
              ...
              c = R.createElement("nav", { role: "navigation" }),
              v = R.createElement("div", { class: "nav-container" });
            ...
            var n,
              ...
              T = !1;
            Z.customToggle
              ? (d = R.getElement(Z.customToggle)) &&
                (d.classList.add("hc-nav-trigger", E),
            ...
            var w = function (e, t, n) {
                if (
                  ...
                  if (
                    ((a = R.children(a, ".nav-content")[0]),
                    (a = R.children(a, "ul")),
                    (a = R.children(a, "li")),
                    (a = R.children(a, ":not(.nav-wrapper)")),
                    ...
                    "number" == typeof e
                      ? a[e].focus()
                      : (k[k.length - 1].focus(), k.pop()),
                      ae.removeEventListener(s),
                      ae.addEventListener(s, function (e) {
              ...
              M = function () {
                ...
                l.add(
                  ...
                  (c.style.display = ""),
                  (v.style.transition = ""),
                  (n = ne.getComputedStyle(v).transitionProperty),
                  (u = R.toMs(ne.getComputedStyle(v).transitionDuration)),
                  (a = ne.getComputedStyle(v).transitionTimingFunction),
                  Z.pushContent &&
                    p &&
                    n &&
                    l.add(
                      R.getElementCssTag(p),
                      "transition: " + n + " " + u + "ms " + a
                    ),
                  l.insert();
              },
              i = function (e) {
                ...
                (R.isNumeric(a) || -1 !== a.indexOf("px")) && (b = parseInt(a)),
                  (R.isNumeric(r) || -1 !== r.indexOf("px")) &&
                    (g = parseInt(r)),
                  te(["disableAt", "position"]) && l.reset(),
                  ...
                  -1 !== ["left", "right"].indexOf(Z.position)
                    ? l.add(
                        ".hc-offcanvas-nav." + E + " .nav-container",
                        "width: " + a
                      )
                    : l.add(
                        ".hc-offcanvas-nav." + E + " .nav-container",
                ...
                var s = c.classList.contains(se),
                  o = [
                    ...
                    R.isIos ? "is-ios" : "",
                    R.isTouchDevice ? "touch-device" : "",
                    s ? se : "",
                    Z.rtl ? "rtl" : "",
                    !Z.labelClose || ("" === Z.labelClose && Z.insertClose)
                      ? "close-no-label"
                      : "",
                  ]
                    .join(" ")
                ...
                c.removeEventListener("click"),
                  ...
                  Z.disableBody && c.addEventListener("click", G),
                  e ? M() : setTimeout(M, 0);
              },
              P = function () {
                var t;
                r = (function o(e, t) {
                  ...
                  Array.prototype.forEach.call(e, function (e) {
                    ...
                    null !== e.getAttribute("data-nav-active") &&
                      ((m = t), e.removeAttribute("data-nav-active")),
                      Array.prototype.forEach.call(e.children, function (e) {
                        ...
                        r.length &&
                          (R.data(e, "hc-uniqid")
                            ? (i = R.data(e, "hc-uniqid"))
                            : ((i = Math.random().toString(36).substr(2)),
                              R.data(e, "hc-uniqid", i))),
                          null !== e.getAttribute("data-nav-active") &&
                            ((m = i), e.removeAttribute("data-nav-active")),
                          s.items.push({
                            id: i,
                  ...
                  ((t = Array.prototype.slice.call(e.querySelectorAll("ul"))),
                  "UL" === e.tagName && t.unshift(e),
                  [t[0]].concat(
                    Array.prototype.filter.call(
                      t[0].parentNode.children,
                      function (e) {
                        return e !== t[0];
                      }
                    )
              ...
              _ = function (e) {
                ...
                !(function m(e, t, y, b, n, a) {
                  ...
                  var r = R.createElement("div", { class: "nav-content" });
                  ...
                  e.forEach(function (e, t) {
                    ...
                    r.appendChild(h),
                      Z.keepClasses &&
                        e.classes &&
                        h.classList.add.apply(
                          h.classList,
                          e.classes.split(" ")
                        ),
                      0 === t && b && h.setAttribute("aria-label", b),
                      e.id && h.setAttribute("aria-labelledby", "menu-" + e.id),
                      e.items.forEach(function (e, t) {
                        ...
                        var r,
                          i = Array.prototype.filter.call(n, function (e) {
                            return (
                              "A" === e.tagName ||
                              (3 !== e.nodeType && e.querySelector("a"))
                            );
                          })[0];
                        i
                          ? (r = R.clone(i, !1, !0)).classList.add("nav-item")
                          : (r = R.createElement(
                          ...
                          i &&
                            r.addEventListener("click", function (e) {
                              e.stopPropagation(),
                                R.hasListener(i, "click") && i.click();
                            }),
                          "#" === r.getAttribute("href") &&
                            r.addEventListener("click", R.preventDefault),
                          Z.closeOnClick &&
                            (W()
                              ? "A" !== r.tagName ||
                        ...
                        if (
                          ...
                          Z.keepClasses &&
                            e.classes &&
                            (s.className = e.classes),
                          e.highlight && s.classList.add("nav-highlight"),
                          R.wrap(
                            r,
                            R.createElement("div", {
                        ...
                        if (e.subnav.length) {
                          ...
                          if (
                            ...
                            d.addEventListener("click", R.stopPropagation),
                            ...
                            var p = function (e) {
                              e.addEventListener("click", function (e) {
                                ...
                                e.setAttribute("aria-controls", "menu-" + c),
                                e.setAttribute(
                                  "aria-haspopup",
                                  "overlap" === Z.levelOpen
                                ),
                            ...
                            if (
                              (-1 !== x.indexOf(c) &&
                                (g.classList.add("sub-level-open"),
                              ...
                              var f = R.createElement(
                                "a",
                                {
                                  ...
                                  class: "nav-next",
                                  "aria-label":
                                    (Z.ariaLabels || {}).submenu + ": " + v,
                                  role: "menuitem",
                                  tabindex: 0,
                                },
                                R.createElement("span")
                              );
                              f.addEventListener("click", R.preventClick()),
                  ...
                  if (
                    ...
                    var i = R.children(r, "ul"),
                      ...
                      l = R.createElement("li", { class: "nav-back" }, o),
                      c = function () {
                        return J(y, n);
                      };
                    R.wrap(
                      o,
                      R.createElement("div", { class: "nav-item-wrapper" })
                    ),
                      o.addEventListener("click", R.preventClick(c)),
                      o.addEventListener("keydown", function (e) {
                        ("Enter" !== e.key && 13 !== e.keyCode) || (C = !0);
                      }),
                      !0 === Z.insertBack
                        ? i[0].insertBefore(l, i[0].firstChild)
                        : R.isNumeric(Z.insertBack) &&
                          R.insertAt(l, Z.insertBack, i);
                  }
                  if (0 === y && !1 !== Z.insertClose) {
                    var v = R.children(r, "ul"),
                      u = R.createElement(
                        "a",
                        { href: "#", role: "menuitem", tabindex: 0 },
                        "object" == typeof Z.labelClose
                          ? R.getElement(Z.labelClose)
                          : [Z.labelClose || "", R.createElement("span")]
                      ),
                      d = R.createElement("li", { class: "nav-close" }, u);
                    (Z.labelClose && "" !== Z.labelClose) ||
                      u.setAttribute("aria-label", (Z.ariaLabels || {}).close),
                      R.wrap(
                        u,
                        R.createElement("div", { class: "nav-item-wrapper" })
                      ),
                      u.addEventListener("click", R.preventClick(G)),
                      u.addEventListener("keydown", function (e) {
                        ("Enter" !== e.key && 13 !== e.keyCode) || S();
                      }),
                      !0 === Z.insertClose
                        ? v[0].insertBefore(d, v[0].firstChild)
                        : R.isNumeric(Z.insertClose) &&
                          R.insertAt(d, Z.insertClose, v);
                  }
                })(r, v, 0, Z.navTitle);
              },
              t = function (t) {
                return function (e) {
                  ("left" !== Z.position && "right" !== Z.position) ||
                    ((o = e.touches[0].clientX),
                    (O = e.touches[0].clientY),
                    "doc" === t
                      ? T ||
                        (ae.addEventListener("touchmove", q, R.supportsPassive),
                        ae.addEventListener("touchend", D, R.supportsPassive))
                      : ((T = !0),
                        v.addEventListener("touchmove", H, R.supportsPassive),
                        v.addEventListener("touchend", I, R.supportsPassive)));
                };
              },
              j = function (e, t) {
                ne.addEventListener(
                  ...
                  (v.style[R.browserPrefix("transition")] = "none"),
                  R.setTransform(v, e, Z.position),
                  p &&
                    ((p.style[R.browserPrefix("transition")] = "none"),
                    R.setTransform(p, t, Z.position));
              },
              B = function (e, t, n, a) {
                void 0 === t && (t = !0),
                  void 0 === n && (n = !1),
                  ...
                  (v.style[R.browserPrefix("transition")] = ""),
                  R.setTransform(v, n, Z.position),
                  p &&
                    ((p.style[R.browserPrefix("transition")] = ""),
                    R.setTransform(p, a, Z.position)),
                  "open" === e
                    ? Y()
                    : (G(),
                      t
              ...
              q = function (e) {
                ...
                (t =
                  "left" === Z.position
                    ? Math.min(Math.max(t, 0), a)
                    : Math.abs(Math.min(Math.max(t, -a), 0))),
                  (("left" === Z.position && o < 50) ||
                    ("right" === Z.position && o > ae.clientWidth - 50)) &&
                    ((N = !0), j(0 - (b - t), Math.abs(t)));
              },
              D = function e(t) {
                if (
                  (ae.removeEventListener("touchmove", q),
                  ae.removeEventListener("touchend", e),
                  N)
                ) {
                  ...
                  (a =
                    "left" === Z.position
                      ? Math.min(Math.max(a, 0), i)
                      : Math.abs(Math.min(Math.max(a, -i), 0)))
                    ? B(70 < a ? "open" : "close")
                    : B("close", !1),
                    (O = o = null),
                    (N = !1);
              ...
              H = function (e) {
                ...
                if (!(Math.abs(t) < Math.abs(n))) {
                  ...
                  (t =
                    "left" === Z.position
                      ? Math.min(Math.max(t, -r), 0)
                      : Math.min(Math.max(t, 0), r)),
                    (("left" === Z.position && t < 0) ||
                      ("right" === Z.position && 0 < t)) &&
                      ((N = !0), j(-Math.abs(t) + a, r - Math.abs(t)));
                }
              },
              I = function e(t) {
                if (
                  ...
                  (a =
                    "left" === Z.position
                      ? Math.abs(Math.min(Math.max(a, -i), 0))
                      : Math.abs(Math.min(Math.max(a, 0), i))) === i
                    ? B("close", !1)
                    : 50 < a
                    ? B("close")
                    : B("open", !0, r, i),
            ...
            i(),
              P(),
              _(),
              !0 === Z.removeOriginalNav
                ? e.parentNode.removeChild(e)
                : e.classList.add("hc-nav-original", E),
              "prepend" === Z.bodyInsert
                ? ae.body.insertBefore(c, ae.body.firstChild)
                : "append" === Z.bodyInsert && ae.body.appendChild(c),
              !0 === Z.expanded && ((h = !0), Y()),
              Z.swipeGestures &&
                (v.addEventListener("touchstart", t("nav"), R.supportsPassive),
                ae.addEventListener("touchstart", t("doc"), R.supportsPassive)),
              ae.addEventListener("keydown", function (e) {
            ...
            var U = function (e, t, n) {
              ...
              if (a) {
                ...
                if (
                  ...
                  -1 !== x.indexOf(r) && x.splice(x.indexOf(r), 1),
                  n &&
                    "overlap" === Z.levelOpen &&
                    (s.removeEventListener("click"),
                    s.addEventListener("click", R.stopPropagation),
                    R.setTransform(v, (e - 1) * Z.levelSpacing, Z.position),
                    p))
                ) {
            ...
            if (
              ...
              ((function () {
                ...
                (f = !0),
                  ...
                  c.classList.add(se),
                  d.classList.add("toggle-open"),
                  "expand" === Z.levelOpen && L && clearTimeout(L);
                Z.disableBody &&
                  ((y =
                    ne.pageYOffset ||
                    re.scrollTop ||
                    ...
                    ae.body.scrollTop),
                  R.hasScrollBar() && re.classList.add("hc-nav-yscroll"),
                  ae.body.classList.add("hc-nav-open"),
                  y && (ae.body.style.top = -y + "px"));
                if (p) {
                ...
                if (h) return (h = !1);
                setTimeout(function () {
                  c._eventListeners.open &&
                    c._eventListeners.open.forEach(function (e) {
                      e.fn(
                        R.customEventObject("open", c, c),
                        Object.assign({}, Z)
                      );
                    });
                }, u);
              ...
              var n;
              if (
                ("number" != typeof e && !R.isNumeric(e)) ||
                ("number" != typeof t && !R.isNumeric(t))
              )
                m
                  ? ((n = Array.prototype.filter.call(
                    ...
                    (!Z.closeActiveLevel && Z.closeOpenLevels) || (m = null))
                  : !1 === Z.closeOpenLevels &&
              ...
              if (n) {
                ...
                if (
                  ...
                  for (var i = 0; i < r.length; i++) {
                    ...
                    0 < o &&
                      a.push({ level: o, index: Number(s.dataset.index) });
                  }
                  a = a.reverse();
                }
                a.push({ level: e, index: t });
                for (var l = 0; l < a.length; l++)
                  $(a[l].level, a[l].index, !1);
              }
            }
          }
          function G() {
            if (X()) {
              if (
                ((f = !1),
                p && R.setTransform(p, !1),
                c.classList.remove(se),
                c.setAttribute("aria-hidden", !0),
                v.removeAttribute("style"),
                d.classList.remove("toggle-open"),
                "expand" === Z.levelOpen &&
                -1 !== ["top", "bottom"].indexOf(Z.position)
                  ? J(0)
                  : W() &&
                    (L = setTimeout(
                      function () {
                      ...
                      "expand" === Z.levelOpen ? u : 0
                    )),
                Z.disableBody &&
                  (ae.body.classList.remove("hc-nav-open"),
                  re.classList.remove("hc-nav-yscroll"),
                  y))
              ) {
                if (
                  ((ae.body.style.top = ""),
              ...
              setTimeout(function () {
                (c.style.visibility = ""),
                  c._eventListeners.close &&
                    c._eventListeners.close.forEach(function (e) {
                      e.fn(
                        R.customEventObject("close", c, c),
                        Object.assign({}, Z)
                      );
                    }),
                  c._eventListeners["close.once"] &&
                    c._eventListeners["close.once"].forEach(function (e) {
                      e.fn(
                        R.customEventObject("close.once", c, c),
                        Object.assign({}, Z)
                      );
                    }),
          ...
          function $(t, n, e) {
            ...
            if (
              ...
              -1 === x.indexOf(r) && x.push(r),
              "overlap" === Z.levelOpen &&
                (s.addEventListener("click", function () {
                  return J(t, n);
                }),
                R.setTransform(v, t * Z.levelSpacing, Z.position),
                p))
            ) {
              var l = "x" === R.getAxis(Z.position) ? b : g;
              R.setTransform(p, l + t * Z.levelSpacing, Z.position);
            }
            c._eventListeners["open.level"] &&
              c._eventListeners["open.level"].forEach(function (e) {
                e.fn(
                  R.customEventObject("open.level", c, o, {
                    currentLevel: t,
                    currentIndex: n,
                  }),
                  Object.assign({}, Z)
          ...
          function J(t, e) {
            ...
            if (0 < t && c._eventListeners["close.level"]) {
              ...
              c._eventListeners["close.level"].forEach(function (e) {
                e.fn(
                  R.customEventObject("close.level", c, r, {
                    currentLevel: t - 1,
                    currentIndex: Q(),
                  }),
                  Object.assign({}, Z)
  ...
  (function (n) {
    ...
    (EventTarget.prototype.addEventListener = u("add")),
      (EventTarget.prototype.removeEventListener = u("remove"));
    ...
    e.Helpers = {
      ...
      insertAt: function (e, t, n) {
        var a = v(n),
          ...
          i =
            -1 < t
              ? Math.max(0, Math.min(t - 1, r))
              : Math.max(0, Math.min(r + t + 1, r));
        0 === i
