    ...
    <div class="container">
      <a class="navbar-brand mr-lg-3 mr-xl-5" href="index.html"
        ><img
          ...
          width="120px"
          height="40px"
          alt="Megabyte Technologies logo"
      /></a>
      ...
      <div class="collapse navbar-collapse" id="toggle-menu">
        <ul class="navbar-nav nav-pills w-100">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if ($currentPage == 'projects') {echo 'active';}?>" href="projects.php">Projects</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if ($currentPage == 'gallery') {echo 'active';}?>" href="gallery.php">Gallery</a>
          </li>
          <li class="nav-item">
