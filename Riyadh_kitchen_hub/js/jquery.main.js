$(document).ready(function () {
  ...
  function initSlickCarousel() {
    jQuery(".bannerSlider").slick({
      ...
      rows: 0,
      prevArrow:
        '<a href="#" class="slickPrev ti-angle-left d-flex align-items-center justify-content-center"><span class="sr-only">Previous slide</span></a>',
      nextArrow:
        '<a href="#" class="slickNext ti-angle-right d-flex align-items-center justify-content-center"><span class="sr-only">Next slide</span></a>',
      autoplay: true,
      autoplaySpeed: 10000,
      speed: 2000,
      fade: true,
      ...
      responsive: [
        {
          ...
          settings: {
            ...
            dots: true,
            dotsClass:
              "slickDots d-flex justify-content-center flex-wrap list-unstyled",
          },
        },
      ],
    });
    ...
    jQuery(".testimonialSwitcherSlider").slick({
      ...
      rows: 0,
      prevArrow:
        '<a href="#" class="slickPrev ei_arrow_left d-flex align-items-center justify-content-center"><span class="sr-only">Previous slide</span></a>',
      nextArrow:
        '<a href="#" class="slickNext ei_arrow_right d-flex align-items-center justify-content-center"><span class="sr-only">Next slide</span></a>',
      infinite: false,
      variableWidth: true,
    ...
    jQuery(".prPostsSlider").slick({
      ...
      dots: true,
      dotsClass:
        "slickBars d-flex justify-content-center flex-wrap list-unstyled",
      adaptiveHeight: true,
      responsive: [
        {
          breakpoint: 1440,
    ...
    jQuery(".npProjectsSlider").slick({
      ...
      rows: 0,
      prevArrow:
        '<a href="#" class="slickPrev ei_arrow_left"><span class="sr-only">Previous slide</span></a>',
      nextArrow:
        '<a href="#" class="slickNext ei_arrow_right"><span class="sr-only">Next slide</span></a>',
      adaptiveHeight: true,
      responsive: [
        {
          breakpoint: 576,
