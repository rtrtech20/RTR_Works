    ...
    if ("destroy" !== o) {
      ...
      return this.each(function () {
        ...
        function u(t) {
          ...
          var o = N.input.val();
          "" !== o &&
            ((o = Number(N.input.val())), N.input.val(o.toFixed(F.decimals)));
        }
        function p() {
          F = t.extend({}, e, E, r(), o);
        }
        ...
        function l() {
          var t = B.val(),
            o = B.parent();
          "" !== t && (t = Number(t).toFixed(F.decimals)),
            B.data("initvalue", t).val(t),
            B.addClass("form-control"),
            o.hasClass("input-group") ? d(o) : f();
        }
        function d(o) {
        ...
        function f() {
          ...
          (o = F.verticalbuttons
            ...
            B.hasClass("input-sm")
              ? M.addClass("input-group-sm")
              : B.hasClass("input-lg") && M.addClass("input-group-lg");
        }
        function b() {
          N = {
            ...
            input: t("input", M),
            prefix: t(".bootstrap-touchspin-prefix", M).addClass(
              F.prefix_extraclass
            ),
            postfix: t(".bootstrap-touchspin-postfix", M).addClass(
              F.postfix_extraclass
            ),
          };
        }
        function h() {
          "" === F.prefix && N.prefix.hide(),
            "" === F.postfix && N.postfix.hide();
        }
        function v() {
          B.on("keydown", function (t) {
            var o = t.keyCode || t.which;
            38 === o
              ? ("up" !== A && (y(), D()), t.preventDefault())
              : 40 === o && ("down" !== A && (_(), C()), t.preventDefault());
          }),
            ...
            N.up.on("mousedown.touchspin", function (t) {
              N.up.off("touchstart.touchspin"),
                B.is(":disabled") ||
                  (y(), D(), t.preventDefault(), t.stopPropagation());
            }),
        ...
        function g() {
          ...
          "" !== (t = B.val())
            ...
            : "" !== F.replacementval &&
              (B.val(F.replacementval), B.trigger("change"));
        }
        function w() {
          if (F.booster) {
            ...
            return (
              F.maxboostedstep &&
                t > F.maxboostedstep &&
                ((t = F.maxboostedstep), (P = Math.round(P / t) * t)),
              Math.max(F.step, t)
            );
          }
          return F.step;
        ...
        function y() {
          ...
          var t = P,
            o = w();
          (P += o) > F.max && ((P = F.max), B.trigger("touchspin.on.max"), k()),
            N.input.val(Number(P).toFixed(F.decimals)),
            t !== P && B.trigger("change");
        }
        function _() {
          g(), (P = parseFloat(N.input.val())), isNaN(P) && (P = 0);
          var t = P,
            o = w();
          (P -= o) < F.min && ((P = F.min), B.trigger("touchspin.on.min"), k()),
            N.input.val(P.toFixed(F.decimals)),
            t !== P && B.trigger("change");
        }
        function C() {
          k(),
